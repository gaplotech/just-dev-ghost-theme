/* PrismJS 1.17.1
https://prismjs.com/download.html#themes=prism-tomorrow&languages=markup+css+clike+javascript+bash+dart+docker+git+java+javadoclike+jsdoc+js-extras+js-templates+json+kotlin+markdown+jsx+tsx+sql+swift+typescript&plugins=line-highlight+line-numbers+show-language+toolbar+copy-to-clipboard */
...
(function () {
	...
	Prism.plugins.toolbar.registerButton('show-language', function (env) {
		...
		element.textContent = 'GapStyle(' + '.' + env.language + ')' ;
